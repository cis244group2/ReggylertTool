...
import javafx.stage.Stage;import java.sql.*;
...
public class Controller_User_CreateAccount {
   ...
   @FXML
    ...
    public void initializedb() throws ClassNotFoundException, SQLException {
    	...
    	Connection connection = DriverManager.getConnection("jdbc:sqlite:V:\\TrumanCollege"
    			+ "\\CISApps\\workspace-student\\ReggylertTool\\ReggylertTool\\ReggylertTool_V2"
    			+ "\\src\\applicationReggylerTool_V2\\Database_RT.db");
    ...
    public void createUserAccount(ActionEvent event) throws ClassNotFoundException, SQLException, IOException {
    	...
    	if(checkPassword(password1, confirmPassword1)) {
    		...
    		lbAlert.setText("Those Passwords didn't match.Try again.");
